...
function Card({ image, title, description, tags }) {
  ...
  return (
    <div className="flex flex-col gap-1 aspect-[4/5] w-[400px] rounded-lg glass-effect ">
      <div
        className="aspect-4/5 w-[400px] bg-cover bg-center rounded-lg" 
      >
        <img src={image} className='relative rounded-lg shadow-lg' />
        ...
        <div className={`rounded-lg ${tags_color} w-fit px-5 absolute top-5 right-4 shadow-md capitalize font-serif font-normal hover:px-6 hover:h-[25px] transition-all duration-300 cursor-pointer`}>
        {tags}
        </div>
      </div>
